...
```
<!-- helper:constraints:end -->

## Skill Contract

Skills that use ontology should declare:

<!-- helper:skill-contract:start -->
```yaml
...
This section is reserved for helper-generated extension documentation (e.g. lineage support).
